...
#  en  = paste("imgs/",fec,"_",sns,".html",sep="")
  ...
  matd[ir,"panel"]=paste("http://138.100.82.181/~tecnalia/Salas_",
                         en,sep="")
}
#
...
htmlwidgets::saveWidget(pg,"/home/tecnalia/git/Salas/Ambiente.html")
pg
#
```
...
#
    ...
    dp[i,"panel"]=paste(
              "http://138.100.82.181/~tecnalia/Salas_imgs/month-",
...
htmlwidgets::saveWidget(pg2,"/home/tecnalia/git/Salas/Horas.html")
pg2
```
...
#
ldat3 = ldat
ldat  = lapply(ldat,filtmin,"Humidity.*",10)
dd    = names(ldat)
